...
MOONANIMATION_HANDLER =DisableAbleCommandHandler("moon",moon)
CLOCKANIMATION_HANDLER =DisableAbleCommandHandler("clock",clock)
BLOCKANIMATION_HANDLER =DisableAbleCommandHandler("block",block)
EARTHANIMATION_HANDLER =DisableAbleCommandHandler("earth",earth)

...
import TechlockRobot.modules.sql.global_bans_sql as gban_sql
import TechlockRobot.modules.sql.users_sql as user_sql
from TechlockRobot import DEV_USERS, OWNER_ID, dispatcher

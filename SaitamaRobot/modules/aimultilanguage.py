...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Techlock AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Techlock AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Techlock AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Techlock AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )

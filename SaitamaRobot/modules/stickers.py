...
async def _(event):
    ...
    packname = f"{first_name}'s kang pack vol {pack} "
    packshortname = f"Techlock_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if I'm steal it")

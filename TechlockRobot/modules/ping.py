...
from TechlockRobot import StartTime, dispatcher
...
PING_HANDLER = DisableAbleCommandHandler("pingg", ping)
PINGALL_HANDLER = DisableAbleCommandHandler("pinggall", pingall)

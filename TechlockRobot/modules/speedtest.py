import speedtest
from TechlockRobot import DEV_USERS, dispatcher
...
SPEED_TEST_HANDLER = DisableAbleCommandHandler("speedtestt", speedtestxyz)
SPEED_TEST_CALLBACKHANDLER = CallbackQueryHandler(
    speedtestxyz_callback, pattern="speedtestt_.*",
)

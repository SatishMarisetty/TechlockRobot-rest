...
import telegram
from TechlockRobot import TIGERS, WOLVES, dispatcher
from TechlockRobot.modules.disable import DisableAbleCommandHandler
from TechlockRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from TechlockRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from TechlockRobot.modules.helper_funcs.string_handling import split_quotes
from TechlockRobot.modules.log_channel import loggable
from TechlockRobot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if user.id in WOLVES:
        if warner:
            message.reply_text("Garrisons abilities make them warn immune.")
        else:
            message.reply_text(
